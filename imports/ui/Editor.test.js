...
if (Meteor.isClient) {
    describe('Editor', function() {
        ...
        it('should render pick note message', function() {
            ...
            expect(wrapper.find('p').text()).toBe('Please pick a note to get started');
        });

        it('should render not found message', function() {
            const wrapper = mount( <Editor browserHistory={browserHistory} call={call} selectedNoteId={'234254'}/> );
        ...
        it('should set not set state if note prop is missing', function() {
            const wrapper = mount(<Editor browserHistory={browserHistory} call={call}/>);
